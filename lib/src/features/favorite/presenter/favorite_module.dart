...
import 'package:domain_receitinhas/features/favorite/domain/repositories/favorite_repository_imp.dart';
import 'package:flutter/widgets.dart';

class FavoriteModule implements RegisterModule {
  @override
  Map<String, Widget> routers = {FavoritePage.route: const FavoritePage()};

  @override
  void inicialize() {
    //Repositories
    di.registerFactory<FavoriteRepository>(() => FavoriteRepositoryImp());

    //Controller
    di.registerFactory<FavoriteController>(() => FavoriteController(di()));
  }
}
